...
INSERT INTO `precos` VALUES (1,'2023-10-16 00:00:00.000000',100),(2,'2023-10-17 00:00:00.000000',110),(3,'2023-10-16 00:00:00.000000',161),(9,'2023-10-22 00:00:00.000000',241),(10,'2023-10-23 00:00:00.000000',241),(11,'2023-10-24 00:00:00.000000',237),(12,'2023-10-26 00:00:00.000000',240),(13,'2023-11-15 00:00:00.000000',231),(14,'2023-11-16 00:00:00.000000',231),(15,'2023-11-18 00:00:00.000000',235);
/*!40000 ALTER TABLE `precos` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `recent_weights`
--

DROP TABLE IF EXISTS `recent_weights`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `recent_weights` (
...
--
-- Dumping data for table `recent_weights`
--

LOCK TABLES `recent_weights` WRITE;
/*!40000 ALTER TABLE `recent_weights` DISABLE KEYS */;
/*!40000 ALTER TABLE `recent_weights` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `report` VALUES (16,'vitin@gmail.com','2023-11-15 12:12:16.231000','credit-card',15,'BILL-1700061136206'),(17,'vitin@gmail.com','2023-11-15 12:12:56.486000','credit-card',15,'BILL-1700061176484'),(18,'vitin@gmail.com','2023-11-15 12:44:24.572000','credit-card',15,'BILL-1700063064556'),(19,'ademir@gmail.com','2023-11-16 16:31:58.057000','credit-card',15,'BILL-1700163118054'),(20,'ademir@gmail.com','2023-11-18 12:31:39.156000','credit-card',15,'BILL-1700321499152');
...
INSERT INTO `users` VALUES (1,'saurav','1234567890','vitor.bovino@gmail.com','123456','user','false'),(7,'vitin','1234567890','vitin@gmail.com','12345','admin','true'),(8,'indian','1234567890','indian.bovino@gmail.com','123456','user','true'),(9,'Ademir Carlet','5432342341','ademir@gmail.com','12345','user','true');
...
-- Dump completed on 2023-11-21 19:00:09
